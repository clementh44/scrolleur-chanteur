      ...
      <b-button-toolbar>
        ...
        <b-button-group class="mr-1 mb-1">
          ...
          <b-button
            ...
            "
            v-b-tooltip.hover
            title="Supprimer les styles (gras, italique, souligné, barré, couleur)"
            variant="light"
          >
        ...
        <b-button-group class="mr-1 mb-1">
          ...
          <b-button
            ...
            "
            v-b-tooltip.hover
            title="Supprimer la couleur de la sélection"
            variant="light"
          >
        ...
        <b-button-group class="mr-1 mb-1">
          ...
          <b-button
            ...
            "
            v-b-tooltip.hover
            title="Supprimer le style du bloc (liste, citation, titre...)"
            variant="light"
          >
            <font-awesome-icon icon="remove-format"></font-awesome-icon>
          </b-button>
        ...
        <b-button-group class="mr-1 mb-1">
          ...
          <b-button
            ...
            "
            v-b-tooltip.hover
            title="Retour à la ligne (sans nouveau paragraphe) Shift+Entrée ou Maj+Entrée"
            variant="light"
          >
